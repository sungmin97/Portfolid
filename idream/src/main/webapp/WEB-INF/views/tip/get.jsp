      ...
      <div class="panel-body">
       ...
       <div class="form-group" style="display: none;">
        ...
        <div class="form-group">
         	<label class="tipcontent">제목</label> <input class="form-control boardtitle" name='title'
...
<!-- Page572 ~ 573까지 소스 코딩 끝 -->
     ...
     <sec:authentication property="principal" var="pinfo"/>
	    ...
	    <button data-oper='list' class="btn btn-info" onclick="location.href='/tip/list'" style="float: right; margin: 0 5px;">목록</button>	
  </div>
