...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">내용은 구체적으로 작성하셔야 많은 도움이 됩니다.</div>
      <!-- /.panel-heading -->
      <div class="panel-body">
       ...
       <div class="form-group" style="display: none;">
        ...
        <div class="form-group">
         	<label class="inquirycontent">제목</label> <input class="form-control boardtitle" name='title'
             value='<c:out value="${board.title}" />' readonly="readonly">
        
          <label>작성자</label> <input style="text-align: center;" class="form-control boardwriter" name='writer' value='<c:out value="${board.writer}" />'
             readonly="readonly">
        </div>
...
<!-- 
<button data-oper='modify' class="btn btn-default" onclick="location.href='/notice/modify?qno=<c:out value="${board.qno}" /> '">Modify 수정!</button>
 -->        
...
<!-- Page572 ~ 573까지 소스 코딩 끝 -->
     ...
     <sec:authentication property="principal" var="pinfo"/>
        ...
        <button data-oper='modify' class="btn btn-default" style="float: right;">글 수정</button>
        </c:if>
        </sec:authorize>
	      	     
	     <button data-oper='list' class="btn btn-info" onclick="location.href='/inquiry/list'" style="float: right; margin: 0 5px;">목록</button>	
  </div>
...
<script type="text/javascript" src="/resources/js/inquiryreply.js"></script>
...
$(document).ready(function() {
	var qnoValue = '<c:out value="${board.qno}"/>';
	var replyUL = $(".chat");
...
<script type="text/javascript">
	...
	/*
	replyService.add(
		{reply: "Javascript TEST", replyer: "tester", qno: qnoValue}
		,
		function(result) {
			alert("RESULT : " + result);
		}
