     ...
     <input type='hidden' name='amount' value='<c:out value="${cri.amount}"/>'>      
      ...
      <div class="form-group">
       ...
       <td><div class="form-group">
          <label>나이</label> <input class="form-control" name='age' value='<c:out value="${board.age}" />'
             readonly="readonly">
        </div></td>
        <td>
         <div class="form-group">
        ...
        <tr>
         <td><div class="form-group">
          <label>키</label> <input class="form-control" name='cm' value='<c:out value="${board.cm}" />'
             readonly="readonly">
        </div></td>
        
         <td><div class="form-group">
          <label>몸무게</label> <input class="form-control" name='kg' value='<c:out value="${board.kg}" />'
             readonly="readonly">
        </div></td>
        <td>
         <div class="form-group">
        ...
        <tr>
         <td><div class="form-group">
          <label>발생 일시</label> <input class="form-control" name='aday' value='<c:out value="${board.aday}" />'
             readonly="readonly">
        </div></td>
        <td colspan="2">
         <div class="form-group">
