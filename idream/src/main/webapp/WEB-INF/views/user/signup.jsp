				...
				<div class="panel panel-primary">
					<div class="panel-body">
						<form method="post" name="join" id="join" action="/user/signup">
							...
							<div class="form-group">
								<label for="email" class="list">이메일<span id="emailError"></span></label><br />
								<input type="text" id="email" maxlength="20"
									class="check form-control" name="email" placeholder="이메일 입력하세요">
